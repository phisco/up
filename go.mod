...
require (
	...
	github.com/crossplane/crossplane v1.14.0-rc.0.0.20230929150103-53f713cda4d6
	github.com/crossplane/crossplane-runtime v1.14.0-rc.0.0.20230919042158-960a14fac774
